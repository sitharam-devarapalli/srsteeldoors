...
import Residential from '../../assests/Residential Doors-banner.jpg';
    ...
    return (
        <div className="sr-steel-product-wrapper">
            ...
            <div className="contact-page-banner mb-5">
                ...
                <div className="contact-page-banner-heading">Steel Doors - Residential</div>
            </div>
            <Container>
                <div className="sr-steel-product-heading text-center">
                    <h2>
                        <strong className="text-white">Residential Doors</strong>
                    </h2>
                </div>
                <Row className="mt-4">
